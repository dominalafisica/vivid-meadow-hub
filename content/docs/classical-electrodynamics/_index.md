  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        <img src="/docs/classical-electrodynamics/images/Captura_pantalla.png" alt="Preview" style="width: 100%; height: 100%; object-fit: cover; object-position: top; opacity: 0.6; transition: opacity 0.2s;">
        ...
        <div style="margin-top: 15px; font-style: italic; font-size: 1rem; color: #d1d5db;">[Descripción extendida del documento.]</div>
        </details>
        </div>
